...
class Message1WithOffsets {
  ...
  encode(buffer, offset = 0) {
    ...
    header.blockLength = Message1WithOffsets.BLOCK_LENGTH;
    header.templateId = Message1WithOffsets.TEMPLATE_ID;
    header.schemaId = Message1WithOffsets.SCHEMA_ID;
    header.version = Message1WithOffsets.SCHEMA_VERSION;
